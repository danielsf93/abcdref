...
/**
 * @file plugins/importexport/abcdref/classes/form/AbcdRefSettingsForm.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2003-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class AbcdRefSettingsForm
 * @ingroup plugins_importexport_abcdref
 *
 * @brief Form for journal managers to setup AbcdRef plugin
 */


import('lib.pkp.classes.form.Form');

class AbcdRefSettingsForm extends Form {
	...
	/**
	 * Constructor
	 * @param $plugin AbcdRefExportPlugin
	...
	function __construct($plugin, $contextId) {
		...
		$this->addCheck(new FormValidator($this, 'depositorName', 'required', 'plugins.importexport.abcdref.settings.form.depositorNameRequired'));
		$this->addCheck(new FormValidatorEmail($this, 'depositorEmail', 'required', 'plugins.importexport.abcdref.settings.form.depositorEmailRequired'));
