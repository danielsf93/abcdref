...
/**
 * @file plugins/importexport/abcdref/filter/ArticleAbcdrefXmlFilter.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2000-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class ArticleAbcdrefXmlFilter
 * @ingroup plugins_importexport_abcdref
 *
 * @brief Class that converts an Article to a Abcdref XML document.
 */

import('plugins.importexport.abcdref.filter.IssueAbcdrefXmlFilter');

class ArticleAbcdrefXmlFilter extends IssueAbcdrefXmlFilter {
	/**
	 * Constructor
	 * @param $filterGroup FilterGroup
	 */
	function __construct($filterGroup) {
		$this->setDisplayName('Abcdref XML article export');
	...
	function getClassName() {
		return 'plugins.importexport.abcdref.filter.ArticleAbcdrefXmlFilter';
	}
	...
	//
	/**
	 * @copydoc IssueAbcdrefXmlFilter::createJournalNode()
	 */
	...
	function createJournalArticleNode($doc, $submission) {
		...
		// pages
		// AbcdRef requires first_page and last_page of any contiguous range, then any other ranges go in other_pages
		...
		if (!empty($pages)) {
			...
			// AbcdRef accepts no punctuation in first_page or last_page
