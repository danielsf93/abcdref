<?php
/**
 * @defgroup plugins_importexport_abcdref Abcdref export plugin
 */

/**
 * @file plugins/importexport/abcdref/AbcdrefExportDeployment.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2000-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class AbcdrefExportDeployment
 * @ingroup plugins_importexport_abcdref
 *
 * @brief Base class configuring the abcdref export process to an
